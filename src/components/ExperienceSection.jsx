...
export default function ExperienceSection() {
  ...
  return (
    <section
      ...
      style={{
        position: 'relative',
        padding: isMobile ? '0 4% 60px' : '0 6% 80px',
      }}
    >
          ...
          return (
            <div
              ...
              style={{
                ...
                position: 'relative',
                marginBottom: index < experience.length - 1 ? (isMobile ? '30px' : '50px') : '0',
            ...
            >
              ...
              >
                ...
                <p style={{
                  fontSize: '0.95rem', color: '#9ca3b0', fontWeight: 400, lineHeight: 1.6,
                }}>
                  {exp.description}
                </p>
              </div>
